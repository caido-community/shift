...
const inputSchema = z.object({
  ...
  payloads: z
    .array(payloadSchema)
    .describe("Array of payload definitions. This is optional, use empty array for default."),
});
...
const toGraphQLPayload = (payload: AutomatePayload): AutomatePayloadOptionsInput => {
...
export const automateSessionCreateTool = tool({
  ...
  execute: async (
    ...
    const raw = normalizeRawHttpRequest(sanitized);
    ...
    return ActionResult.ok("Automate session created");
  },
});
